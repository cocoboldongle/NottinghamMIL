...
def build_model(cfg):
    if cfg.pretrain == 'natural_supervised' and cfg.backbone == 'ViT-B/16':
        ...
        print("⚡ Loading ResNet18 as Backbone ⚡")
    ...
    elif cfg.pretrain == 'uni' and cfg.backbone.startswith('hf-hub'):
        load_dotenv()
        ...
        raise ValueError(f"Unsupported combination: pretrain={cfg.pretrain}, backbone={cfg.backbone}")
