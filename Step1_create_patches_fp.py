...
def walk_dir(data_dir,
             file_types=['.svs', '.ndpi', '.mrxs', '.hdx', '.sdpc', '.mdsx', '.tif', '.tiff', '.tmap']):
    path_list = []
...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir,
    ...
    svs_files = glob.glob(f"{args.source}/*.svs")
    tif_files = glob.glob(f"{args.source}/*.tif")

    
    slides = svs_files + tif_files
